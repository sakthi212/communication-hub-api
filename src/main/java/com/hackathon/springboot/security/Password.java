...
/*
 * 
 * public class Password { // Define the BCrypt workload to use when generating
 * password hashes. 10-31 is a valid value. private static int workload = 12;
 * 
 *//**
 ...
 * stored_hash) { boolean password_verified = false;
 * 
 * if(null == stored_hash || !stored_hash.startsWith("$2a$")) throw new
 * java.lang.IllegalArgumentException("Invalid hash provided for comparison");
 * 
 ...
 *//**
	 ...
	 *//*
		 * public static void main(String[] args) { String test_passwd = "test123";
		 * String test_hash =
